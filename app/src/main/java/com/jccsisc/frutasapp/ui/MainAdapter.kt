...
class MainAdapter(private val context: Context, private val frutasList: List<Fruta>) : RecyclerView.Adapter<BaseViewHolder<*>>() {
    ...
    inner class FruitViewHolde(val binding: CardFrutasBinding) : BaseViewHolder<Fruta>(binding.root) {
